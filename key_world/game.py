...
from key_world.world import World, Door, Key, Lookups, Pos, MainDoor
...
class Game:
    def __init__(
        ...
        self.FLOOR_IMAGE = "key_world/images/floor.png"
        self.KEY_IMAGE = "key_world/images/key.png"
        self.AGENT_IMAGE = "key_world/images/agent.png"
        self.gui = gui
        if human_player:
            assert self.gui
        self.record = record
